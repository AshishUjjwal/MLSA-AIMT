...
import logs from '../Images/Ml-removebg-preview.png'
    ...
    <div className={styles.home}>
      <div className={styles.content}>
        <div className={styles.mlsa}>
            <h1><b>Welcome To <br></br>MLSA-AIMT</b></h1>
        </div>
        <div className={styles.para}>
          <h3><p>
            ...
            <span>Empowering students to code their future, master AI, and shape tomorrow's tech culture.</span>
            </p>
          </h3>
        </div>
